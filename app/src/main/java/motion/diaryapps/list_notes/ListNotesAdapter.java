...
public class ListNotesAdapter extends RecyclerView.Adapter<ListNotesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.noteTitle.setText(mLists.get(position).getTitle());
        viewHolder.noteDate.setText(Tools.getNormalDate(mLists.get(position).getDate()));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            noteTitle = itemView.findViewById(R.id.tvItemListNotesTitle);
            noteDate = itemView.findViewById(R.id.tvItemListNotesDate);
        }
    }
}
